### Hi there, I'm Charan Velusamy - aka [Charanquartz][website] <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="25px">

[![Website](https://img.shields.io/website?label=cqrtz.in&style=for-the-badge&url=https%3A%2F%2Fcqrtz.in)](https://cqrtz.in)
...
I'm an engineer specializing in **Embedded Systems, Cloud-Native Architecture, and DevOps Infrastructure**. My work spans from low-level embedded firmware (Linux/Yocto) to full-stack web applications and highly available cloud deployments.

- 🌍 **Portfolio**: [cqrtz.in](https://cqrtz.in)
- 📝 **Dev Notes & Docs**: [dev.cqrtz.in](https://dev.cqrtz.in)
- 🌱 I’m currently focused on advanced HomeLab networking, Rust development, and edge-to-cloud automation.
- ⚡ Fun fact: I love engineering complex hardware/software systems and self-hosting my own infrastructure!
...
**Systems & Embedded:** Rust, C, C++, Embedded Linux, Yocto Project, BitBake, FreeRTOS  
**Web & Cloud:** TypeScript, React, Next.js, Node.js, Tailwind CSS, Oracle Cloud, Azure, Cloudflare  
**DevOps & Infrastructure:** Docker, Podman, Git, Prometheus, Grafana, PostgreSQL, MongoDB, Bash  
...
<table border="0" cellspacing="0"">
  <tr><th align="center"colspan="2"> GitHub Stats</th></tr>
<tr><td>
...
<details>
  <summary>:zap: GitHub Stats (Detailed)</summary>
...
[website]: https://cqrtz.in
[dev]: https://dev.cqrtz.in
